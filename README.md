...
| 仓库 | 描述 |
|------|------|
| [areuok](https://github.com/nicepeng/areuok) | 📱 客户端应用（本仓库） |
| [areuok-server](https://github.com/nicepeng/areuok-server) | ☁️ 云端服务端 |
...
详细 API 文档请参阅 [areuok-server 文档](https://github.com/nicepeng/areuok-server#api-documentation)。
...
- [许可证](./LICENSE)
- [移动端构建指南](./docs/MOBILE_BUILD_GUIDE.md)
...
本项目是「死了么」（现已更名为 [DAMUMU](https://www.damumu.fun/)）App 的开源替代版本。在中文社区，「死了么」这个名称更为人所知。感谢原作者的创意灵感！
...
**核心框架**
- [Tauri](https://tauri.app/) - 使用 Web 技术构建更小、更快、更安全的桌面和移动应用
- [Svelte](https://svelte.dev/) & [SvelteKit](https://kit.svelte.dev/) - 编译时前端框架
- [Rust](https://www.rust-lang.org/) - 安全、并发、高性能的系统编程语言

**Rust 生态**
- [lettre](https://github.com/lettre/lettre) - Rust 邮件发送库
...
**外部服务**
- [一言 API](https://hitokoto.cn/) - 提供每日励志语录
